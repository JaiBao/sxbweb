<template>
  <q-layout view="hHh lpr fff">
    <q-header reveal elevated class="header" height-hint="98">
      <q-toolbar>
        <q-toolbar-title class="headerLogo">
          <div class="logoBtn" @click="navigateToHome"><img src="/head/logo.svg" class="logoImg pointer" /></div>
        </q-toolbar-title>
    ...
    <q-drawer v-model="rightDrawerOpen" side="right" behavior="mobile" bordered class="column bg-white text-black items-end" :width="200" style="z-index: 2999">
      ...
      <q-list class="drawerList">
        ...
        <q-item class="column items-end" clickable to="/recommend" @click="rightDrawerOpen = false">
          <q-item-section class="drawerItem">口碑推薦</q-item-section>
        </q-item>
      </q-list>
    </q-drawer>
          ...
          <div class="footerList">
            <div class="list1">
              ...
              <div class="listContent">
                ...
                <router-link to="/recommend" class="textHover"><p>口碑推薦</p></router-link>
              </div>
            </div>
    ...
    <q-btn class="scroll-to-top" :class="{ visible: isScrolled, 'at-bottom': atBottom }" round @click="scrollToTop">
      <q-icon name="keyboard_control_key" size="md" color="white" />
    </q-btn>
  </q-layout>
</template>
...
const startAnimation = () => {
  ...
  gsap.to('.icon-1', { left: '250%', duration: 0.5 })
  gsap.fromTo('.icon-2', { left: '-200%' }, { left: '50%', duration: 0.5 })
}
