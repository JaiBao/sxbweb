<template>
  ...
  <q-card class="column newsContentCard">
    <div class="newsContentTitle row justify-center text-yellow-7 weight-700">
    <h3 >隱私權政策</h3>
  </div>
  <div class="newsContentContent row justify-start">
    <h5 >
      「少小白官方網站」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</h5>
    <p>
     <spn class="text-yellow-7 weight-700"> 一、隱私權保護政策的適用範圍</spn>
    <br>
    隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。</p>
    <p>
      <spn class="text-yellow-7 weight-700">       二、個人資料的蒐集、處理及利用方式</spn>
  ...
  <ul>
    ...
    <p>
      <spn class="text-yellow-7 weight-700">      三、資料之保護</spn>
  ...
  <p>
    <spn class="text-yellow-7 weight-700">   四、網站對外的相關連結</spn>
 
    <br>
    本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。</p>
  <p>
    <spn class="text-yellow-7 weight-700"> 五、與第三人共用個人資料之政策</spn>
  ...
  <p>
    <spn class="text-yellow-7 weight-700"> 六、Cookie 之使用</spn>
  ...
  <p>
    <spn class="text-yellow-7 weight-700">七、隱私權保護政策之修正</spn>
  ...
  .newsContentCard{
    ...
    h3{
      // background: url('/connection/bg.png') no-repeat 100% 35% / contain;
